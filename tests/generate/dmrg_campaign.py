    ...
    for camp in (
        ...
        Campaign(
            ...
            physics_note="the actinide leg: U(3+) 5f^3, ground 4I9/2 split by the ligand "
                         ...
                         "field",
            protocol_note="⚠ THE LADDER RUNS AT SCALAR-GUESS ORBITALS. ⚠ The reference SA-10 "
                          "CASSCF CONVERGES since the constrained Kramers rotation "
                          "(2026-09-13: 11 macro-iterations from the guess, |g| 7.8e-5, "
                          "doublets 0, 353, 699, 1490, 1529 cm^-1, boundary gap 3179 "
                          "cm^-1) -- but only from the GUESS: a checkpoint written by an "
                          "unconstrained run is paired only to 7.5e-9, the optimizer then "
                          "leaves the rotation general, and every trial step is refused "
                          "for splitting a pair. The ladders were measured before that and "
                          "stay at the guess. What follows is the history: the reference "
                          "SA-10 CASSCF DID NOT CONVERGE HERE. Four step engines were "
